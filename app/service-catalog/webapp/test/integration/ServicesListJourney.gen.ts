...
function journey() {
    QUnit.module("ServicesListListReport journey");
    ...
    opaTest("Start application", function (Given: Given, _When: When, Then: Then) {
        ...
        Then.onTheServicesListGenerated.iSeeThisPage();
    });
    ...
    //     When.onTheServicesListGenerated.onFilterBar().iChangeSearchField("Search Term");
    //     When.onTheServicesListGenerated.onFilterBar().iExecuteSearch();
    //     Then.onTheServicesListGenerated.onTable(defaultTableId).iCheckRows();
    //     When.onTheServicesListGenerated.onFilterBar().iChangeSearchField(undefined);
    //     Then.onTheServicesListGenerated.onFilterBar().iCheckSearchField(undefined);
    // });
    ...
    opaTest("Navigate to ObjectPage", function (_Given: Given, When: When, Then: Then) {
        ...
        When.onTheServicesListGenerated.onFilterBar().iExecuteSearch();
        Then.onTheServicesListGenerated.onTable(defaultTableId).iCheckRows();
        When.onTheServicesListGenerated.onTable(defaultTableId).iPressRow(0);
